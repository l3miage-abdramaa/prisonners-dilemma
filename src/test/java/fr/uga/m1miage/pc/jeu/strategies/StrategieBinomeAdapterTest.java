...
class StrategieBinomeAdapterTest {
    ...
    void testToujoursTrahir() {
        ...
        assertEquals(CoupEnum.TRAHIR, coup, "La stratégie ToujoursTrahir doit toujours trahir.");
    }
    ...
    void testAleatoire() {
        ...
        CoupEnum coup = adapter.getCoup(List.of());
        assertTrue(coup == CoupEnum.COOPERER || coup == CoupEnum.TRAHIR, "La stratégie Aleatoire doit renvoyer COOPERER ou TRAHIR.");
    }
    ...
    void testDefaultStrategy() {
        ...
        CoupEnum coup = adapter.getCoup(List.of());
        assertEquals(CoupEnum.COOPERER, coup, "La stratégie personnalisée doit renvoyer COOPERER.");
    }
    ...
    void testDefaultStrategyTrahir() {
        ...
        CoupEnum coup = adapter.getCoup(List.of());
        assertEquals(CoupEnum.TRAHIR, coup, "La stratégie personnalisée doit renvoyer TRAHIR.");
    }
}
